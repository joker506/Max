  ...
  ><div>
    ...
    <form class="sign-up">
      ...
      <span class="sign-up__bottom-label">
        ...
        <a class="label_link"> Resend me code (one in 60 seconds)</a>
      </span>
      <div class="check__wrap">
        <Input
          :class="{ input__error: $v.confirCode.$error }"
          size="middle"
  ...
  methods: {
    ...
    changeStep(step) {
      if (this.$v.$invalid) {
        ...
        this.$store
          .dispatch("signUp/signUpCodePhoneCompany", {
